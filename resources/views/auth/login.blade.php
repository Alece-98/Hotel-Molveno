    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded border-gray-300 color-green-600 dark:border-gray-700 text-[#618b98] shadow-sm focus:ring-[#618b98] dark:focus:ring-offset-gray-800" name="remember">
