        ...
        <div class="column width55 flex flexVertical gap20">
            <div class="gap20 flex widthFull">
                <div class="column withHalf">
                    ...
                    <input class="smallInput" name="adults" id="adults" type="number" placeholder="2" value="{{$roomInfo[0]->adults}}">
                </div>
                ...
                <div class="column withHalf">
                    ...
                    <input class="smallInput" name="children" id="children" type="number" placeholder="0" value="{{$roomInfo[0]->children}}">
                </div>
            </div>
            ...
            <div class="gap20 flex widthFull normalHeight">
                <div class="column withHalf checkBox">
                    ...
                    <input name="babybed" id="babybed" type="checkbox" {{ $roomInfo[0]->babybed === 1 ? "checked" : "" }}>
                </div>
                ...
                <div class="column withHalf checkBox">
                    ...
                    <input name="handicap" id="handicap" type="checkbox" {{ $roomInfo[0]->handicap === 1 ? "checked" : "" }}>
                </div>
            </div>
            ...
            <div class="gap20 flex widthFull">
                <div class="column withHalf">
                    ...
                    <input disabled class="smallInput" name="arrival" id="arrival" type="date" value="{{$roomInfo[0]->arrival}}">
                </div>
                ...
                <div class="column withHalf">
                    ...
                    <input disabled class="smallInput" name="departure" id="departure" type="date" value="{{$roomInfo[0]->departure}}">
                </div>
            </div>

            <div class="flex widthFull comment">
                <label class="width100 paddin8" for="comments">Comments:</label>
                <textarea class="flexGrow textArea" name="comments" id="comments" cols="30" rows="10" placeholder="Enter comment here." value="{{$roomInfo[0]->comment}}"></textarea>
            </div>

            <div class="gap20 flex widthFull">
                <p>Room id: {{$roomInfo[0]->room_id}}</p>
            </div>
